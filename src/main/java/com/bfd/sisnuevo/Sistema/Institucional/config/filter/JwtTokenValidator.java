package com.bfd.sisnuevo.Sistema.Institucional.config.filter;
...
public class JwtTokenValidator extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        if(jwtToken != null) {
            ...
            String username = jwtUtils.extracUsuario(decodedJWT);
            //me devuelve claim, necesito pasarlo a String
            String authorities = jwtUtils.traerClaimEspecifico(decodedJWT, "authorities").asString();
